...
function App() {
  ...
  return (
    <div>
      ...
      <h1 style={{ fontWeight: "bold", paddingLeft: "50px", paddingRight: "50px", fontSize:"40px", marginBottom:"40px"}}>Upload Your .CSV File With The Columns: Employer Name,	Description, Job Type, Primary Contact and Primary Contact Email</h1>
