...
function InputStuff({email, subject, body, active}){
  ...
  return (
    <div style={{alignItems:'left', textAlign:"left"}}>
      ...
      <textarea id="bodyInput" type="text" value={bodyN} style={{width:"1050px", height:"30vh", color:"#727272", border:"0px", borderRadius:"8px", fontSize:"15px", padding:"10px 10px 10px 10px", overflowX:'hidden'}} onChange={handleBody} disabled={!active}/>
